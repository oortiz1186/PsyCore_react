...
export default function PatientRecordPage() {
  ...
  return <>
    ...
    <section className="patient-record-hero">
      ...
      <div className="patient-record-actions"><Link className="btn btn-secondary" href={`/appointments?patient=${patient.id}`}>Agendar cita</Link><button className="btn btn-primary" onClick={() => setTab('notes')}>Nueva nota SOAP</button></div>
    </section>
